...
<div class="card border-0 shadow-sm overflow-hidden">
    ...
    <div class="card-header bg-white py-3 border-0">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mb-3">
            <div class="d-flex align-items-center gap-3">
                ...
                <strong class="fs-6 text-dark">Lihat Hasil Akhir Peringkat Kelas</strong>
                <span class="badge rounded-pill px-2 py-1" style="background: #e0e7ff; color: #4338ca; font-weight: 600; font-size: 0.75rem;">
                    <?= e($batch['kelas']) ?> &bull; <?= $labelSemester[$batch['semester_target']] ?? '—' ?> &bull; <?= e($batch['tahun_ajaran']) ?>
                </span>
        ...
        <form method="GET" action="<?= e(url('')) ?>" id="formFilterHasil">
            <input type="hidden" name="url" value="hasil/kelas-lihat">
    ...
    <!-- Body Card: Tabel Hasil Peringkat Kelas -->
    <div class="card-body p-3 pt-0">
        ...
        <div class="d-flex align-items-center justify-content-between flex-wrap gap-3 mt-3">
            ...
            <?php if ($totalPages > 1): ?>
            <nav class="mx-auto">
                <?php $pageUrl = url('hasil/kelas-lihat') . "&id=$id&limit=$limit&q=" . urlencode($search); ?>
...
<div id="batchDataInfo" 
     ...
     data-kls-clean="<?= str_replace(['/', ' '], '-', $batch['kelas']) ?>" 
     data-smt-clean="<?= ($batch['semester_target'] == '1' ? 'Ganjil' : 'Genap') ?>" 
     data-view-kelas="<?= e($batch['kelas']) ?>" 
...
<!-- SCRIPT JS -->
<script src="<?= e(asset('assets/js/pages/hasil-kelas.js')); ?>"></script>
